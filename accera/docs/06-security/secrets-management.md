# ACCERA Secrets Management

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Storage/access for keys, credentials, tokens, certificates and secrets.

Secrets live in an approved manager or deployment environment, never source control/logs/clients; rotate and audit access.
