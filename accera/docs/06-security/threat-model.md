...
Threat actors, assets, attack surfaces, trust boundaries, scenarios and mitigations.

Update on material architecture change; include abuse of multi-tenancy, payments, minors, privileged tools and integrations.
