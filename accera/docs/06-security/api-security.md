...
API validation, authorization, rate limits, abuse controls, injection prevention and secure headers.

Apply controls at every public boundary and log decisions without storing credentials or sensitive request bodies.
