# ACCERA Device Security

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Device trust, local storage, biometric capabilities, device sessions and lost-device protection.

Store the minimum locally, protect tokens with platform secure storage and support remote session revocation.
