# ACCERA Session Security

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Session lifecycle, token expiration/refresh/revocation and suspicious-session response.

Bind tokens to intended audience, rotate refresh tokens, permit revocation and require re-authentication for sensitive actions.
