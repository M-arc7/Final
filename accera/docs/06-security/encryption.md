...
Encryption in transit, at rest, key ownership, rotation and certificate standards.

Use modern managed encryption, TLS everywhere and separate encryption/signing secrets from application configuration.
