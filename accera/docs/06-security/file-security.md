# ACCERA File Security

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Upload validation, access control, scanning, signed access, media isolation and malicious-file prevention.

Verify content type and size server-side, quarantine/scan before publish and use opaque paths with time-limited URLs.
