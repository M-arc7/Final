...
What ACCERA must accomplish now: remove the operational fragmentation between people, organisations and sport activity.

Define present users, problems, operating model, immediate value and explicit non-goals. Product scope belongs in product documents; this page sets the current mandate.
