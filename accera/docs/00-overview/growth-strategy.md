# ACCERA Growth Strategy

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Acquisition and retention strategy for athletes, academies, facilities, competitions and organisations, including network effects, partnerships, sponsorship, geographic, product-led and community-led growth.

Identify the loop, activation event, retention signal, owner and measurement for each channel. Do not imply unconsented marketing or data use.
