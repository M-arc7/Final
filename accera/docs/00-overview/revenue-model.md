# ACCERA Revenue Model

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Operational revenue architecture for subscriptions, booking fees, commissions, academy payments, competition registration, ticketing, sponsorship, advertising, enterprise and ethically permitted data services.

For every stream define payer, payee, timing, ledger event, tax responsibility, refund/payout path and system of record.
