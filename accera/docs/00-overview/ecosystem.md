...
How people, organisations, sports, facilities, academies, competitions, commerce, finance, sponsors, performance, content and intelligence create one connected system.

Describe causal relationships and shared identifiers. Do not specify tables or APIs; those belong to database and API documentation.
