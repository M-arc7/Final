# ACCERA Target Markets

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Initial and expansion geographies, sports, customer segments, facilities, academies, organisations, enterprises and international markets.

Record inclusion criteria, localisation assumptions, regulation dependencies and segment needs. Market-entry sequencing belongs to expansion strategy.
