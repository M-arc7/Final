...
Wallets, transactions, invoices, subscriptions, payouts, refunds, commissions and accounting relationships.

Own immutable financial records and reconciliation. Other domains request charges but cannot create arbitrary settled ledger entries.
