...
Competition lifecycle: creation, registration, draws, schedules, scoring, officials, results and ranking publication inputs.

Own the event-of-play and its official result workflow. Sports owns generic rules; rankings owns cross-competition calculation.
