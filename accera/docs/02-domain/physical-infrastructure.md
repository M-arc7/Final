# ACCERA Physical Infrastructure

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Courts, academies, arenas, training facilities, competition venues and future physical infrastructure.

Set portfolio and lifecycle requirements for physical assets. Facilities owns operational availability and bookings.
