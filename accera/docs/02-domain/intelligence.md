...
Analytics, recommendations, predictions, athlete/facility/business intelligence.

Own derived insight models and explanation metadata. It reads governed domain data and never becomes the source of operational truth.
