...
Identity, users, profiles, organisations, roles, permissions, memberships, notifications, messaging, files, search, audit and settings.

Own the canonical actor and tenant context used by every other domain. Do not own sport- or transaction-specific state.
