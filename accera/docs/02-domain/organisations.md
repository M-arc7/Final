# ACCERA Organisations

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Organisation types, ownership, structure, relationships, branches, staff and organisational permissions.

Own organization topology and membership context. Core owns identities and generic roles; facility/academy/competition own their operations.
...
Business capability ownership; persistent representations are governed by the database documentation. This page is authoritative only for the boundary stated above; it links to, rather than repeats, details owned by another document.
