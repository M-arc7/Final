# ACCERA Frontend Architecture

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Web and mobile application structure, shared components, feature modules, state, data fetching, routing, responsive behaviour, accessibility and error handling.

Applications compose domain contracts and must not duplicate policy, money calculations or tenant authorization.
