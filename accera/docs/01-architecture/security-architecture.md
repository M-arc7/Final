# ACCERA Security Architecture

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

System-wide identity, authorization, RLS, application/API/infrastructure security, encryption, secrets, auditability and threat boundaries.

Security controls are defense in depth. This page delegates operating rules to `docs/06-security/`.
