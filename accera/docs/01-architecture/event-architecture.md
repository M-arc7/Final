# ACCERA Event Architecture

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Domain-event producers/consumers, naming, payload envelope, persistence, queues, retry, idempotency and failure recovery.

Events publish facts after committed state changes; they are not a substitute for synchronous authorization decisions.
