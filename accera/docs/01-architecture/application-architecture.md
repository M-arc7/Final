# ACCERA Application Architecture

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Responsibility and boundaries of web, player, coach, facility, competition, official, admin and mobile applications.

Assign every role workflow to a primary application and prohibit divergent implementations of domain logic.
