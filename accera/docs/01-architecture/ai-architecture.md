# ACCERA Ai Architecture

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

AI services/models, data boundaries, prompts, recommendation and prediction use cases, security, human oversight and cost controls.

AI can propose or summarize; deterministic domain rules, authorization and financial decisions stay outside the model boundary.
