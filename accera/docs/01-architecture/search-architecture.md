# ACCERA Search Architecture

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Search across people, athletes, organisations, facilities, competitions, events, products and content.

Define indexing owner, searchable fields, ranking, filters, permission enforcement and removal propagation. Search is never the authorization source.
