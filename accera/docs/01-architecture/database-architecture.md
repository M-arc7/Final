# ACCERA Database Architecture

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

PostgreSQL/Supabase schemas, domain boundaries, relationships, security, indexes, transactions, functions, triggers, views and scale strategy.

The database is the durable source of truth. Detailed objects are documented in `docs/03-database/`.
