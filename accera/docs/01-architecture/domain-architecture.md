# ACCERA Domain Architecture

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Boundaries among core, sports, facilities, academy, competition, commerce, finance, sponsorship, performance, content and intelligence.

Define ownership, shared identifiers, allowed dependencies, synchronous contracts and events; cross-domain writes require the owning domain API.
