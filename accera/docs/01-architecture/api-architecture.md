# ACCERA Api Architecture

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Application-to-service communication, API boundaries, conventions, identity, authorization, validation, versioning, errors, rate limits and provider isolation.

Every endpoint has one domain owner and a documented contract; no application may query another domain’s private persistence directly.
