# ACCERA Disaster Recovery Architecture

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Recovery objectives, backups, failover, database/storage/service recovery, data integrity and disaster exercises.

Set RTO/RPO by service criticality and require verified restoration, not merely successful backup jobs.
