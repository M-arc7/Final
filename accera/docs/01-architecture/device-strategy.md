# ACCERA Device Strategy

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Desktop, laptop, tablet, mobile, facility terminal, competition and official scoring device behaviour.

Specify supported form factors, degraded/offline behavior, input constraints, privacy and device-loss requirements. UI details belong to product docs.
