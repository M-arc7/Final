# ACCERA Notification Architecture

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Push, email, SMS, in-app and system alerts: triggers, preferences, templates, delivery, retry and permission controls.

Notification requests are event-driven, deduplicated and auditable; delivery failure must not roll back the originating business action.
