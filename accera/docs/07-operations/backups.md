...
Operational backup schedules, retention, validation and restore testing.

Name accountable owner, encrypted storage, recovery evidence and escalation for failed backups.
