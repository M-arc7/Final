# ACCERA Database Operations

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Routine migrations, maintenance, optimization, monitoring and recovery.

Use reviewed runbooks, query/lock observation, backup verification and a clear stop/rollback condition.
