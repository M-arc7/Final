# ACCERA Release Management

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Versioning, preparation, approval, deployment, rollback and release notes.

Every release names owner, scope, risk, migration state, rollout metric and rollback/forward-fix decision path.
