# ACCERA Secret Rotation

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Rotation of API keys, credentials, signing keys, certificates and sensitive credentials.

Support overlapping validity, inventory consumers, test replacement, revoke old secret and record completion without exposing values.
