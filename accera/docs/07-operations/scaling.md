...
When/how compute, database, storage, APIs, queues, search and realtime scale.

Scale from measured bottlenecks with tested runbooks; preserve RLS, backups, observability and cost controls.
