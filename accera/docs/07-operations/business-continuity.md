# ACCERA Business Continuity

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Maintaining critical business operations during technical, operational, infrastructure or external disruption.

Identify critical services, manual fallback, authority, communications, vendor dependencies and recovery exercise cadence.
