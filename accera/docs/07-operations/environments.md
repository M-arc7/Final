...
Development, staging and production environment purpose and separation.

No production data/secrets in lower environments without approved controls; promotion uses immutable artifacts and scoped credentials.
