# ACCERA Disaster Recovery

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Operational recovery after infrastructure or service failure.

Translate architecture RTO/RPO into runbooks, role assignments, communications, decision authority and exercised restoration.
