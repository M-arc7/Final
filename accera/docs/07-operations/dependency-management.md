# ACCERA Dependency Management

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Selection, versioning, vulnerabilities, updates, lockfiles and removal.

Prefer maintained, licensed dependencies; pin reproducible lockfiles and remove unused packages after compatibility checks.
