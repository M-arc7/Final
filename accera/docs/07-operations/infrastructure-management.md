# ACCERA Infrastructure Management

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Hosting, network, compute, storage, database, domains, certificates and resource management.

Manage infrastructure as reviewed configuration, tag ownership/cost, restrict change access and maintain inventory.
