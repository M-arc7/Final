...
Alert severity, routing, escalation and noise control.

Alert on actionable symptoms tied to an owner/runbook; tune thresholds with error budgets and measure acknowledgement/resolution.
