...
Observability requirements across services and infrastructure.

Define service-level indicators, dashboards, ownership, retention and the path from alert to trace/log/correlation ID.
