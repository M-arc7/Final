...
Application, infrastructure, security, audit and database logging.

Use structured logs with correlation/tenant context, redaction, access control, retention and tamper-aware audit separation.
