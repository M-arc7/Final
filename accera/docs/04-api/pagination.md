...
Cursor pagination standard, ordering guarantees and metadata.

Use opaque, stable cursors for mutable lists; never use offset pagination for unbounded or permission-sensitive feeds.
