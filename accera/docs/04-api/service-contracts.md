# ACCERA Service Contracts

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Typed contracts between backend services and domains.

Specify owner, commands/queries/events, input/output, invariants, timeout/retry and compatible evolution.
