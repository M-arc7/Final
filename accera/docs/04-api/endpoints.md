...
Route/resource structure, HTTP methods, ownership and lifecycle semantics.

Each endpoint declares its domain owner, auth requirement, request/response schema, errors and idempotency behavior.
