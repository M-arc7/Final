...
Inbound/outbound webhook contracts, signatures, replay protection, retries, delivery logs and idempotency.

Acknowledge safely, persist delivery state, verify provider signatures and process expensive work asynchronously.
