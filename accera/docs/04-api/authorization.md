# ACCERA Authorization

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

API access evaluation across roles, permissions, organisation boundaries and RLS.

Enforce before side effects and retain RLS as final protection. Do not trust client-supplied role, tenant or ownership fields.
...
Boundary contract for applications, Edge Functions, workers and partners. This page is authoritative only for the boundary stated above; it links to, rather than repeats, details owned by another document.
