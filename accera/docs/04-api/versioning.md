...
Compatibility and versioning strategy for public/internal APIs and event payloads.

Prefer additive evolution; define deprecation notice, migration support and removal approval for breaking change.
