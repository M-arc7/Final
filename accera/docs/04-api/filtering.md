...
Allowed filtering fields/operators and validation.

Filters are domain-owned, indexed where needed, type-safe and applied after tenant/authorization scoping.
