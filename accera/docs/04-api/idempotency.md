...
Safe repeat handling for payments, bookings, registrations, orders and webhooks.

Persist an idempotency key scoped to actor and operation, bind it to request hash and replay the original result.
