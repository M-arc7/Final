...
API/domain event envelope, versioning, producer/consumer and payload rules.

Events state an immutable fact with IDs, occurred time, actor/tenant context and schema version; no secrets in payloads.
