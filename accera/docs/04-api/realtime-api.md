...
Realtime channels, subscriptions, authorization, payloads, reconnection and ordering.

Channel names must not reveal private data; clients resync authoritative state after gaps or reconnect.
