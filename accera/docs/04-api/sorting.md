...
Allowed sort keys, direction, default order and deterministic tie-breaker.

Only expose indexed/approved fields and append an immutable ID tie-breaker to prevent duplicate/missing pages.
