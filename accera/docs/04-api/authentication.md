# ACCERA Authentication

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

API identity mechanisms, token verification, service credentials and client authentication flows.

Authentication proves identity; authorization is a separate policy decision documented in `authorization.md`.
