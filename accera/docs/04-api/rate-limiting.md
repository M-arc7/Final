# ACCERA Rate Limiting

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Limits, abuse prevention, throttling policy and client feedback.

Set limits by identity, tenant, IP and operation cost; sensitive endpoints use stricter, observable controls.
