# ACCERA Response Format

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Standard success, collection, metadata and correlation-ID response shapes.

Responses expose only fields authorized for the caller and use stable names/types.
