# ACCERA Error Handling

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Error codes, structures, client recovery behavior and logging.

Separate safe public messages from internal cause; every error carries a correlation ID and no secrets or PII.
