...
Archival of inactive/historical data while preserving required recoverability.

Archived data remains access-controlled and discoverable only through approved read paths; restoration is tested.
