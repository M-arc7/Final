...
Identifier-generation requirements and when sequences are appropriate.

Prefer UUIDs for public and distributed entity identity; sequences may support local ordering or human-friendly numbering.
