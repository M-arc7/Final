...
Database integrity: non-null, check, unique, exclusion, foreign-key and tenancy constraints.

Enforce invariants closest to data. Application validation improves UX but never replaces these guarantees.
