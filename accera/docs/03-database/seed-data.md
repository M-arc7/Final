...
Development, staging and controlled production seed data.

Seeds are deterministic, non-secret and tagged; production seeds are minimal, approved and never masquerade as user activity.
