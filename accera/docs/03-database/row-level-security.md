...
RLS policies and tenant/data-access boundaries.

Policies operate on authenticated identity plus organisation membership. Test both permitted and denied cases for every table.
