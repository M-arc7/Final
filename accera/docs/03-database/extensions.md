...
Required PostgreSQL/Supabase extensions, purpose, privileges and migration ordering.

Each extension must be approved for managed Supabase compatibility and threat impact.
