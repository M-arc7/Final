...
Controlled PostgreSQL enum types, allowed values and safe evolution rules.

Use enums only for small, stable domains; changing values requires compatibility and migration planning.
