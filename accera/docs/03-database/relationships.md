# ACCERA Relationships

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Foreign keys and cross-domain relationships between entities.

Record owner, cardinality, delete behavior, tenant invariant and whether writes require a service contract.
