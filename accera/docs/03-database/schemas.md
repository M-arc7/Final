...
PostgreSQL schema boundaries and ownership.

Separate public application data from private/internal functions and extensions. Database schema membership follows domain ownership.
