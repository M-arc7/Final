...
Conceptual and logical model: identifiers, tenants, audit fields, lifecycle state, money, time and soft-deletion conventions.

Use this page for common modeling rules; table-specific columns remain in `tables.md`.
