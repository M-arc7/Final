...
Required indexes, the query paths they serve, uniqueness implications and maintenance cost.

Every nontrivial index must identify its predicate/order and be confirmed with realistic query plans before production.
