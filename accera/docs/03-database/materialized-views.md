# ACCERA Materialized Views

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Expensive analytical projections, refresh method, staleness tolerance and indexes.

A materialized view cannot support authorization-sensitive real-time decisions unless its freshness guarantee is explicit.
