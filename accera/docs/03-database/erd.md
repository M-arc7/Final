...
The complete entity-relationship model, grouped by domain with cardinality, optionality, tenant scope and lifecycle notes.

Every diagram relation must map to an actual foreign key, documented polymorphic rule or deliberate non-relational boundary.
