...
Permitted triggers, timing, side effects, ownership and observability.

Triggers are limited to local integrity/audit work; they must not call external systems or hide cross-domain workflows.
