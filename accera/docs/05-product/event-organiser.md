# ACCERA Event Organiser

> **Status:** Baseline controlled specification. Update this document in the same change as any contract it governs.

## Purpose and boundary

Planning, registration, scheduling, ticketing, operations, participants, sponsors and reporting.

Non-competition events use the events domain; competition-specific workflows link to the competition product.
