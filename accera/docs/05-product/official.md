...
Assignments, schedules, matches, scoring, incidents, results and notifications.

Official actions must support constrained/offline scoring, attribution, reconciliation and protected result finalization.
