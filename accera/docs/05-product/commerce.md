...
Customer/vendor catalog, products, cart, order, inventory, payment, fulfillment and promotions.

Define checkout states, inventory reservation, order visibility, fulfillment exceptions and refunds via finance.
