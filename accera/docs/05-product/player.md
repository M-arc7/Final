...
Athlete profile, discovery, bookings, academy, competitions, rankings, performance, commerce, wallet and communication.

Define every player goal, screen state, permission, empty/error state and link to the owning domain contract.
